...
For other environments, you need to update the FDX-YAML policy project which is part of apigateway-config-fdx-7.7.0.20xxxxxx-BNxx.tar.gz and deploy the configuration as detailed in [Mount the FDX Configuration](/docs/deployment/installation/api-management/fdx-apim/#mount-the-fdx-configuration).
